...
RUN pip install boto3 addict tqdm regex pyyaml opencv-python torchsummary albumentations==0.4.6 pretrainedmodels efficientnet_pytorch scikit-image==0.15  yacs tensorboard pydicom joblib mmcv attrdict tiffile git+https://github.com/qubvel/segmentation_models.pytorch 
