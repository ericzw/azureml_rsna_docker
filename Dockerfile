...
RUN pip install boto3 addict tqdm regex pyyaml opencv-python torchsummary albumentations pretrainedmodels efficientnet_pytorch scikit-image==0.15  yacs git+https://github.com/qiuzhongwei-USTB/ResNeSt.git tensorboard pydicom joblib
